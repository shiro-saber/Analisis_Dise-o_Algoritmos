...
int main()
{
	...
	add_edge(8, 9, 3, g);
	t = clock() - t;
	cout << "tardo " << t << "clicks, y " << (((float)t) / CLOCKS_PER_SEC) << "segundos en insertar los vertices y aristas" << endl;
	...
	default_dfs_visitor v;//Para recorrer en la funcion
	...
	t = clock();
	cout << "tardo " << t << "clicks, y " << (((float)t) / CLOCKS_PER_SEC) << "segundos en los recorridos" << endl;
	...
	cout << "tardo " << t << "clicks, y " << (((float)t) / CLOCKS_PER_SEC) << "segundos en prim" << endl;
	...
	t = clock() - t;
	cout << "tardo " << t << "clicks, y " << (((float)t) / CLOCKS_PER_SEC) << "segundos en kruskal" << endl;
